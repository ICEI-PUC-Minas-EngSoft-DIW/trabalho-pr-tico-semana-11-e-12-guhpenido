...
![Print Postman - Metodo GET](https://i.imgur.com/fA8PO0c.png)

![Print Postman - Metodo POST](https://i.imgur.com/gBTeKyc.png)

![Print Postman - Metodo PUT](https://i.imgur.com/S127Y3i.png)

![Print Postman - Metodo DELETE](https://i.imgur.com/WMjvOkW.png)

**Print da aba NETWORK com requisições Fetch/XHR POST e GET**

![Print NETWORK](https://i.imgur.com/FMSn74O.png)
